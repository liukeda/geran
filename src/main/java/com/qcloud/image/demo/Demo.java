...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        String appId = "1257620462";
        String secretId = "AKIDkDbv34dWxdHyyrS5lT5VmxBHI8oHGrP9";
        String secretKey = "mOnz0tmU2MYaO0SjrntrfJm270kNtGRQ";
        String bucketName = "grjy";
...
//        ocrGeneral(imageClient, bucketName);
        ...
        ocrHandwriting(imageClient, bucketName);
...
//        faceLiveDetectPicture(imageClient, bucketName);//人脸静态活体检测
     ...
     * 手写体OCR
     */
    private static void ocrHandwriting(ImageClient imageClient, String bucketName) {
        String ret;
        // 1. url方式
        System.out.println("====================================================");
        GeneralOcrRequest request = new GeneralOcrRequest(bucketName, "http://youtu.qq.com/app/img/experience/char_general/ocr_common09.jpg");
//        ret = imageClient.generalOcr(request);
//        System.out.println("ocrHandwriting:" + ret);

        //2. 图片内容方式
        System.out.println("====================================================");
        request = new GeneralOcrRequest(bucketName, new File("assets", "20180918104327.jpg"));
        ret = imageClient.generalOcr(request);
        System.out.println("ocrHandwriting:" + ret);
    }
